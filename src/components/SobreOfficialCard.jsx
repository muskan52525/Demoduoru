    ...
    return (
      <>
        <div className="bg-white md:pt-[129px] md:pb-[197px] py-[60px]">
          ...
          <h2 className="text-outline-green md:text-6xl text-2xl mt-[38px] mb-[30px] text-center">
            Patrocinadores oficiais
          </h2>
          <div className="max-w-[1400px] md:mx-auto bg-[#E5376B] rounded-[54px] shadow-[0px_4px_4px_0px_#00000040] flex justify-between flex-col md:flex-row items-center p-[62px] gap-[30px] md:mt-[105px]  mt-[30] mx-[20px] px-5">
            ...
            <div>
              ...
              <h2 className="text-[#FFFFFF] text- base md:text-5xl font-bold leading-[45px] mt-[29px] font-mulish">
              ...
              <p className="text-white text-[14px] md:text-[20px] leading-[45px] font-bold font-mulish">
                moimentaandebol@gmail.com
              </p>
              <p className="text-white text-[14px] md:text-[20px] leading-[45px] font-bold font-mulish">
                968118150
              </p>
              <button className="bg-[#A1C128] text-2xl leading-[45px] font-bold font-mulish text-white px-3">
